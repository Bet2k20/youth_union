...
Route::get('/elite-member', [Student5GoodApiController::class, 'eliteMember']);
Route::get('/cam-tinh-dang', [Student5GoodApiController::class, 'eliteMember']);
Route::get('/dang-vien', [Student5GoodApiController::class, 'eliteMember']);
...
Route::get('/bgd', [OutstandingPersonApiController::class, 'bgd']);
Route::get('/ban-giam-doc', [OutstandingPersonApiController::class, 'bgd']);
