...
class SampleDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $people = [
            ...
            // --- ỦY VIÊN BAN CHẤP HÀNH ĐOÀN THANH NIÊN (ỦY VIÊN ĐTN) ---
            [
                'name' => 'Thiếu tá Trần Văn Phú',
                'position' => 'Ủy viên ĐTN',
                'order' => 6,
                'avatar' => '/images/btv-doan/tran-van-phu.jpg',
                'role_group' => 'UY_VIEN_DTN',
                'class_unit' => 'Đoàn Thanh niên Học viện CSND',
                'achievement' => 'Ủy viên Ban Chấp hành Đoàn Thanh niên Học viện CSND',
                'is_active' => true,
            ],
            [
                'name' => 'Thiếu tá Nguyễn Xuân Vinh',
                'position' => 'Ủy viên ĐTN',
                'order' => 7,
                'avatar' => '/images/btv-doan/nguyen-xuan-vinh.jpg',
                'role_group' => 'UY_VIEN_DTN',
            ...
            [
                'name' => 'Trung úy Nguyễn Thành Nghĩa',
                'position' => 'Ủy viên ĐTN',
                'order' => 9,
                'avatar' => '/images/btv-doan/nguyen-thanh-nghia.jpg',
                'role_group' => 'UY_VIEN_DTN',
            ...
            [
                'name' => 'Thiếu úy Nguyễn Xuân Hiếu',
                'position' => 'Ủy viên ĐTN',
                'order' => 10,
                'avatar' => '/images/btv-doan/nguyen-xuan-hieu.jpg',
                'role_group' => 'UY_VIEN_DTN',
