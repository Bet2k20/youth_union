...
class MediaApiController extends Controller
{
    ...
    private function getPhotos(): array
    {
        $photos = [
            ...
            [
                'id' => 10,
                'title' => 'Huân chương Bảo vệ Tổ quốc hạng Ba - Phần thưởng cao quý của Đảng và Nhà nước trao tặng ĐTN T02',
                'image_url' => url('/images/achievements/huan-chuong-bao-ve-to-quoc-hang-3.png'),
                'category' => 'Khen thưởng & Thành tích',
                'date' => '2026-09-11',
            ],
            [
                'id' => 11,
                'title' => 'Cờ thi đua của Ban Chấp hành Trung ương Đoàn TNCS Hồ Chí Minh tặng ĐTN Học viện CSND',
                'image_url' => url('/images/achievements/co-thi-dua-tw-doan-1.png'),
                'category' => 'Khen thưởng & Thành tích',
                'date' => '2026-09-11',
            ],
            [
                'id' => 12,
                'title' => 'Cờ thi đua xuất sắc công tác Đoàn khối trường Đại học - Trung ương Đoàn TNCS Hồ Chí Minh',
                'image_url' => url('/images/achievements/co-thi-dua-tw-doan-2.jpg'),
                'category' => 'Khen thưởng & Thành tích',
                'date' => '2026-09-11',
            ],
            [
                'id' => 13,
                'title' => 'Cờ thi đua đơn vị xuất sắc của Ban Chấp hành Đoàn TNCS Hồ Chí Minh Bộ Công an',
                'image_url' => url('/images/achievements/co-thi-dua-doan-bo-cong-an.jpg'),
                'category' => 'Khen thưởng & Thành tích',
                'date' => '2026-09-11',
            ],
            [
                'id' => 14,
                'title' => 'Bằng khen của Bộ trưởng Bộ Công an trao tặng Đoàn Thanh niên Học viện CSND',
                'image_url' => url('/images/achievements/bang-khen-bo-truong-bca-1.jpg'),
                'category' => 'Khen thưởng & Thành tích',
                'date' => '2026-09-11',
            ],
            [
                'id' => 15,
                'title' => 'Bằng khen của Bộ trưởng Bộ Công an về thành tích xuất sắc trong phong trào thi đua',
                'image_url' => url('/images/achievements/bang-khen-bo-truong-bca-2.jpg'),
                'category' => 'Khen thưởng & Thành tích',
                'date' => '2026-09-11',
            ],
            [
                'id' => 16,
                'title' => 'Bằng khen của Tổng cục trưởng Tổng cục Chính trị CAND trao tặng Tuổi trẻ Học viện',
                'image_url' => url('/images/achievements/bang-khen-tong-cuc-chinh-tri-cand.jpg'),
                'category' => 'Khen thưởng & Thành tích',
                'date' => '2026-09-11',
            ],
            [
                'id' => 17,
                'title' => 'Bằng khen của Ban Chấp hành Trung ương Đoàn TNCS Hồ Chí Minh trao tặng Đoàn Học viện',
                'image_url' => url('/images/achievements/bang-khen-tw-doan-1.jpg'),
                'category' => 'Khen thưởng & Thành tích',
                'date' => '2026-09-11',
            ],
            [
                'id' => 18,
                'title' => 'Bằng khen của Trung ương Đoàn TNCS Hồ Chí Minh về thành tích Chiến dịch thanh niên tình nguyện',
                'image_url' => url('/images/achievements/bang-khen-tw-doan-2.jpg'),
                'category' => 'Khen thưởng & Thành tích',
                'date' => '2026-09-11',
            ],
            [
                'id' => 19,
                'title' => 'Bằng khen của Ban Chấp hành Đoàn Thanh niên Bộ Công an trao tặng Tuổi trẻ PPA',
                'image_url' => url('/images/achievements/bang-khen-doan-bca.jpg'),
                'category' => 'Khen thưởng & Thành tích',
                'date' => '2026-09-11',
            ],
        ];
